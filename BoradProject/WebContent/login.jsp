...
<header><h1><center>자유게시판</center></h1></header>
	...
	<form action="login" method=post >
		<br>
		<label for="loginId" style="font-size:20px">아이디</label> &nbsp;&nbsp;
		<input style="text" name="id" size=20 label=loginId placeholder="ID"><br>
			
		<label for="loginPw" style="font-size:20px">비밀번호</label>
		<input style="password" name="pw" size=20 label=loginPw placeholder="Password"><br>
