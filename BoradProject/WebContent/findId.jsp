...
<head>
	...
	<form action="findId" method=post >
		<h3 style="text-align:center;"><b>아이디 찾기</b></h3><br>
		<br>
		<label for="loginId" style="font-size:15px">이메일</label> &nbsp;&nbsp;
		<input style="text" name="email" size=15 label=loginId placeholder="가입한 이메일"><br><br>
		
		
		<input type="submit" class="btn btn-primary form-control" value="아이디 찾기" style="height:40x; width:240px;"><br>
